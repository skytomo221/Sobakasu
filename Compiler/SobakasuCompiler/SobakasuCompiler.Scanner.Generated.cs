...
//
//  GPLEX Version:  1.2.3
//  DateTime: 2025-04-08 22:54:47
//  GPLEX input file <SobakasuCompiler\SobakasuCompiler.Language.analyzer.lex - 2025-04-08 22:44:56>
...
#if BABEL
     internal sealed partial class SobakasuCompilerScanner : ScanBase, IColorScan
    {
...
#else  // BABEL
     internal sealed partial class SobakasuCompilerScanner : ScanBase
    {
        private ScanBuff buffer;
        int currentScOrd;  // start condition ordinal
#endif // BABEL
...
#if !NOFILES
     internal SobakasuCompilerScanner(Stream file) {
            SetSource(file); // no unicode option
        }   
#endif // !NOFILES

     internal SobakasuCompilerScanner() { }
